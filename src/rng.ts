/**
 * Gerador determinístico. A mesma Semente produz sempre a mesma Pista —
 * é o que faz uma Etapa ser decorável, e portanto jogável com a Câmera Invertida.
...
export function createRng(seed: number): Rng {
  ...
  return { next, range, chance, weighted };
}
